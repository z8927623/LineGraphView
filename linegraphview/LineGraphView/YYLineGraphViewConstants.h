...
#ifndef LineGraphView_YYLineGraphViewConstants_h
#define LineGraphView_YYLineGraphViewConstants_h


// 封闭区域填充颜色
#define kPlotFillColorKey @"kPlotFillColorKey"
// 线段宽度
#define kPlotStrokeWidthKey @"kPlotStrokeWidthKey"
// 线段颜色
#define kPlotStrokeColorKey @"kPlotStrokeColorKey"
// 圆点颜色
...
// x轴Week label的字体
#define kXAxisWeekLabelFontKey @"kXAxisWeekLabelFontKey"
...
// 圆点大小
#define kDotSizeKey @"kDotSizeKey"
#define kBigCircleSizeKey @"kBigCircleSizeKey"
#define kSmallCircleSizeKey @"kSmallCircleSizeKey"

#define SMALL_CIRCLE_COUNT 4
#define LIST_POINT_MARGIN 15
// 底部边缘（字体的高度）
#define BOTTOM_MARGIN_TO_LEAVE 30.0
// y轴度量的范围
#define YAXIS_RANGE 90
// y轴需要划分的部分
